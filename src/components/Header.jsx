export default function Header({ active, setActive }) {
  ...
  return (
    <div className="fixed left-[var(--content-x)] top-[var(--content-y)] text-[var(--fg)] z-10 text-left">
      ...
      <div className="mt-6 sm:mt-8 lg:mt-10 space-y-1 sm:space-y-2 text-left">
        {btn("home", "Home")}
