/**
 * The centrepiece: a Keplerian accretion disk around an event horizon, with
...
export function createBlackHole(canvas: HTMLCanvasElement, size: number): BlackHoleHandle {
